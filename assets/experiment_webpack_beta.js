          ...
          [function(directionForward) {
              ...
              */
              ...
              mainContent.html(`<h2 class='story-h2'>Epilogue</h2>
                                ...
                                <p class='story-legend-text legend-text'><b>Press the <span class='key-indicator'>&#x21e8;</span> key or the <span class='key-indicator'>&nbsp;SPACE&nbsp;</span> bar to start exploring the dataset in more detail! Hover over each dot ( <span class='legend-dot'></span> ) or symbol (<span class='legend-symbol-span'>\u2642/\u2640</span>) to read more about the actor, and the associated production.</b></p>`)
              const height = +document.querySelector('#main-content').getBoundingClientRect().height;
              mainContent.style('top', window.innerHeight/2 - height/2);
